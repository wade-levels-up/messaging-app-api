...
| GET    | /users                                   | Retrieves an array of all the users as objects, containing username, profile picture, bio, who they are friends of and their join date.                                 |
...
**Description:**  
Retrieves an array of all the users as objects, containing username, profile picture, bio, who they are friends of and their join date.
