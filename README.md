...
**Description:**  
Retrieves an array of all the users as objects, containing username, profile picture, bio, who they are friends of, if they are verified and their join date.
...
**Method:** GET
**Endpoint:** `/conversations/recipient_name`

**Description:**  
Retrieves a conversation between the logged in user and the recipient
...
```json
{
  "message": "Conversation with <recipientName> retrieved",
  "conversations": []
}
```
